...
# po power-cut (power-on switchd v5.0). Kolejność patchy: 0001 → 0013.
...
# --- patche ---
# Kolejność 0001→0013 z patches/kernel/; 0001 leży w patches/ (nie kernel/) —
...
# ==========================================================================
echo "=== nv-kepler: budowa jądra z LOCALVERSION=$LOCALVERSION (switchd v5.0, patch 0007 = reinit GK107, 0011-0013 = fix D3hot→D0 hang)"
echo "=== src: $SRC"
